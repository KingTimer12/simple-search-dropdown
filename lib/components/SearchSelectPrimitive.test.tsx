...
import Select from './SearchSelectPrimitive'
...
describe('SearchSelectPrimitive', (it) => {
  ...
  it('if renders item with click on trigger', async () => {
    render(
      <Select>
        <Select.Trigger><Select.Search placeholder="Procurar" /></Select.Trigger>
        <Select.Panel>
          <Select.Item value='1' label='1'>Abacaxi</Select.Item>
          <Select.Item value='2' label='2'>Limão</Select.Item>
        </Select.Panel>
      </Select>
    )
